...
try
{
    ...
    string mover2 = @"C:\Users\Usuario\Desktop\Movertxt\teste.txt";
...
foreach (var dir_ in diretorios)
{
...
string caminhoArquivo_ = @"C:\Users\User\Desktop\Estudo/VScode.txt";
try
{

    using StreamReader leitor_ = File.OpenText(caminhoArquivo_); //Chamada simplificada. "leitor" declarado no bloco.

    string? linha;
    while ((linha = leitor_.ReadLine()) != null)
    {
        Console.WriteLine(linha);
    }
}
